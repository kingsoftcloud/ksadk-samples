# 项目管理交付计划 Agent - DeepAgents

项目管理 Agent 如何围绕项目状态生成交付风险评估、推进计划和验收清单。默认使用公开 fixture，不访问真实项目管理系统。 这是一个多文件 DeepAgents Agent 工程，不是单文件脚本；默认不依赖外部账号，适合作为开源样例和二次开发模板。

## 适用场景

- 想学习 DeepAgents 如何实现 Project Management Delivery Planner。
...
```bash
cd 02-use-cases/project-management/delivery-planner-deepagents
cp ../../../.env.example .env
