...
def evaluate_financial_risks(query: str) -> list[dict]:
    ...
    return _evaluate_financial_risks_raw()


def _evaluate_financial_risks_raw() -> list[dict]:
...
def render_demo_answer(query: str) -> str:
    ...
    risks = _evaluate_financial_risks_raw()
...
def collect_evidence(query: str) -> list[dict]:
    ...
    return load_financial_report(query) + _evaluate_financial_risks_raw()
